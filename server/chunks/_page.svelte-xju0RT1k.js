...
const css = {
  code: ".lastten.svelte-sueg7q{background-color:white;position:absolute;top:50px;left:50px;z-index:401;font-size:13px}@media(max-width: 768px){.lastten.svelte-sueg7q{display:none}}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  var markerLocations = [];
  $$result.css.add(css);
  return ` <div class="w-80 h-auto p-4 lastten shadow-lg rounded-lg svelte-sueg7q"><div class="font-bold text-xl mb-4 border-b pb-2" data-svelte-h="svelte-1o45mwq">Vehículos</div> <div class="space-y-3"><div class="space-y-3">${each(markerLocations, (location) => {
...
//# sourceMappingURL=_page.svelte-xju0RT1k.js.map
